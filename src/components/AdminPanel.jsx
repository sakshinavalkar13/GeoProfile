...
const AdminPanel = () => {
  ...
  return (
    ...
    <div className="admin-panel pt-20 p-6  bg-gray-50 min-h-screen">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-gray-800">Admin Panel</h1>
        <button
          onClick={() => openModal()}
          className="btn bg-[#00A896] text-white py-2 px-4 rounded-md hover:bg-indigo-700 transition"
        >
          Add Profile
        </button>
      </div>
      ...
      {loading ? (
        ...
        <thead>
          <tr className="bg-[#14B8A6]">
            <th className="border border-gray-300 p-3 text-left text-white">Sr No.</th>
            <th className="border border-gray-300 p-3 text-left text-white">Profile Img</th>
            <th className="border border-gray-300 p-3 text-left text-white">Name</th>
            <th className="border border-gray-300 p-3 text-left text-white">Email</th>
            <th className="border text-wrap border-gray-300 p-3 text-left text-white">Description</th>
            <th className="border border-gray-300 p-3 text-left text-white">Address</th>
            <th className="border border-gray-300 p-3 text-center text-white">Actions</th>
          </tr>
        </thead>
            <tbody>
              {filteredProfiles.map((profile, index) => (
                <tr key={profile.id} className="border-b items-center">
                  ...
                  <td className="border border-gray-300 p-4 text-center space-x-4 text-xl">
                    ...
                    <button
                      className="bg-[#00A896] text-white text-base py-1 px-2 rounded hover:bg-indigo-700 transition"
